window.initCharjsCharts = function() {
  Array.from(document.querySelectorAll('canvas[id]')).forEach(el => {
    if (el.id.includes('chart')) {
      // Destroy existing Chart.js instance to prevent canvas reuse error
