1. Introduction
Welcome to the Master ERP SaaS user manual. Dash SaaS is an open-source business platform where a Super Admin manages multiple companies, and each company can use tools for HR, CRM, accounting, projects, and more, with additional functionality available through Add-Ons. This guide is designed for customers who have purchased Dash SaaS. Inside, you’ll find step-by-step instructions covering login, dashboard, company and plan setup, modules, Add-Ons, branding, and system settings.

2. Sign Up Process
The sign-up process in Master ERP SaaS enables administrators to create accounts and access the platform seamlessly. This documentation outlines the step-by-step procedure for administrators to create a new account and gain entry into the system.

2.1 Introduction to the Sign Up Process
The sign-up process is designed to allow administrators to create their accounts within the Master ERP SaaS platform, granting them access to its functionalities and features.

2.2 Accessing the Login Page
Administrators navigate to the designated login page of the Master ERP SaaS platform.
...
Once your account is created, you’ll receive a confirmation email with a verification link. Click the link to activate your account and start using DASH. After verification, you’ll be directed to your personalized dashboard, where you can manage your projects, collaborate with team members, and access all Master ERP SaaS features.
...
With the registered account, administrators can explore and access the diverse features and functionalities offered by Master ERP SaaS.

2.7 Seamless Access
Subsequent logins can be initiated using the sign-up email and password on the login page.

By following these steps, administrators can seamlessly register themselves on the Master ERP SaaS platform, gaining access to a wealth of features and functionalities to streamline their e-commerce operations.

3. Super Admin Login Process
Accessing the Super Admin account within Master ERP SaaS is a straightforward process, allowing you to manage and oversee various aspects of the platform. Here’s how you can log in as a Super Admin:

3.1 Navigate to Login
Visit the Master ERP SaaS login page: yourdomain.com/login
...
Once logged in, you’ll be directed to your personalized dashboard, where you can manage your plans, Add-On manager with dashboard, and access all Master ERP SaaS features.
...
As a Super Admin in Master ERP SaaS, you hold the reins to manage and oversee various pivotal aspects of the platform. This comprehensive documentation will guide you through each module and feature you can access and control, empowering you to optimize the platform’s performance and user experience.
...
Master ERP
4.1.1 Dashboard Overview Metrics
...
4.1.2 Recent Orders (Monthly) Graph
...
4.3.1 Support Ticket Management
...
4.3.2 Helpdesk Categories Management
...
4.6.1 Bank Transfer Requests List Page
...
4.9.1 Marketplace Settings Overview
...
4.11.1 Newsletter Subscribers List Page
...
4.13.1 Notification Templates List Page
...
4.15.1 Add-Ons Manager Overview
...
Enter the application title in the text field (e.g., “Master ERP SaaS”)
...
Enter the footer copyright text in the text field (e.g., “Copyright (c) Master ERP SaaS”)
...
4.16.11 Email Notification Settings
...
5.1 Access Master ERP
Go to the Master ERP website and enter your admin login credentials.
...
6.2.1 Subscription Plans Display:
The platform displays available subscription plans in a card-based layout. Each plan card includes:
...
Master ERP
10 Admin Dashboard
As a Company Admin in Master ERP SaaS, you have access to multiple specialized dashboards based on your activated Add-Ons. These complimentary dashboards are included with your subscription plan and provide comprehensive management tools for different business functions.
...
For complete setup instructions and feature details, check out our Project Add-On Guide
...
For complete setup instructions and feature details, check out our Accounting Add-On Guide
...
For complete setup instructions and feature details, check out our HRM Add-On Guide
...
For complete setup instructions and feature details, check out our POS Add-On Guide
...
For complete setup instructions and feature details, check out our CRM Add-On Guide

Master ERP
Product & Service Overview:
The Product & Service Add-On centralizes product, service, and inventory management by organizing items with categories, taxes, units, pricing, stock quantities, and warehouse assignments.
It enables you to create and manage products, services, and parts, upload product images, maintain inventory levels, and track stock across multiple warehouses from a single module.
For complete setup instructions and feature details, check out our Product & Service Add-On Guide
...
Master ERP SaaS provides complimentary Add-Ons based on your subscription plan. As a Company Admin, you have access to multiple business management Add-Ons through the sidebar navigation menu.
