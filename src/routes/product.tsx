  ...
  head: () => ({
    meta: [
      { title: "Product — Master HRMS" },
      {
        name: "description",
        content:
          "Explore all Master HRMS modules: Core HR, Payroll, Attendance, Leave, Recruitment, Performance, LMS, and Helpdesk.",
      },
      { property: "og:title", content: "Product — Master HRMS" },
      {
        property: "og:description",
        content: "Eight integrated modules for the entire employee lifecycle.",
      },
    ],
  }),
});
...
const modules = [
  {
    ...
    features: [
      ...
      "Lifecycle events (onboarding, transfers, exits)",
  ...
  },
  {
    ...
    features: [
      ...
      "Feedback & scorecards",
      "Offer letters & onboarding handoff",
    ],
  },
  {
    id: "performance",
        ...
        <div className="mx-auto max-w-7xl px-6 space-y-24">
          {modules.map((m, i) => (
            <div
              key={m.id}
              id={m.id}
              className={`grid lg:grid-cols-2 gap-12 items-center scroll-mt-24 ${i % 2 === 1 ? "lg:[&>*:first-child]:order-2" : ""}`}
            >
              <div>
      ...
      <section className="py-20 border-t bg-secondary/40">
        <div className="mx-auto max-w-4xl px-6 text-center">
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight">
            See Master HRMS in action
          </h2>
          <p className="mt-4 text-muted-foreground">
            Book a personalized demo with our HR product experts.
          </p>
