...
function UnderMaintenancePage() {
  ...
  const noticeMsg =
    ...
    "System maintenance is currently in progress. We are performing scheduled database and server upgrades to improve performance.";
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col justify-between p-6">
      ...
      <header className="max-w-6xl mx-auto w-full flex items-center justify-between py-4 border-b border-slate-800">
        ...
        <Badge
          variant="outline"
          className="text-red-400 border-red-500/40 bg-red-500/10 gap-1.5 px-3 py-1 font-mono text-xs"
        >
      ...
      <main className="max-w-2xl mx-auto w-full text-center space-y-6 py-12">
        ...
        <div className="space-y-3">
          ...
          <p className="text-slate-400 text-base max-w-lg mx-auto leading-relaxed">{noticeMsg}</p>
        </div>
