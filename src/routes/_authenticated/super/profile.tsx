...
function SuperProfileAdmin() {
  ...
  async function handleConfirmCrop() {
    ...
    try {
      ...
      setAvatarUrl(croppedBase64);      // 2. Update Profile Avatar via MySQL API
      ...
      try {
        const mediaPage = await api.get("/cms/pages/system-media-library");
        existingFiles = mediaPage?.content?.files || [];
      } catch {}
      ...
      await api.put("/cms/pages/system-media-library", {
        ...
        content: { files: [newMediaItem, ...existingFiles] },
        published: true,
      });

      toast.success(
        "Avatar cropped, saved to profile & stored in Media Library (Profile Avatars)!",
      );
    ...
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      <div className="border-b pb-5">
        ...
        <p className="text-muted-foreground text-sm mt-1">
          Update display username, crop avatar logos with real-time preview, and manage security
          passwords.
        </p>
      </div>
          ...
          <Card className="p-6 space-y-4 border shadow-xs">
              ...
              <div className="space-y-1.5">
                <Label className="text-xs font-semibold flex items-center justify-between">
                  ...
                  <span className="text-[10px] text-muted-foreground">
                    Cropped avatar auto-saves to Media Library
                  </span>
                </Label>
            ...
            <CardFooter className="p-0 pt-4 border-t flex justify-end">
              <Button
                ...
                className="bg-primary font-bold gap-2 text-xs"
              >
                {isSavingProfile ? (
        ...
        <DialogContent className="sm:max-w-[480px]">
          <DialogHeader>
            ...
            <DialogDescription className="text-xs">
              Zoom, rotate, and crop your logo into a high-resolution circular avatar. Saved
              directly to Media Library.
            </DialogDescription>
          </DialogHeader>
              ...
              <div className="space-y-1">
                <div className="flex justify-between font-semibold text-xs">
                  <span className="flex items-center gap-1">
                    <ZoomIn className="size-3.5 text-primary" /> Zoom Level
                  </span>
