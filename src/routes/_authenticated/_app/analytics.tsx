					...
					<div className="grid grid-cols-1 xl:grid-cols-3 gap-3 mb-3">
						...
						<div className="bg-white border border-border-color rounded-md p-4">
							...
							<div className="space-y-3">
								<div className="flex items-center justify-between gap-3"><div className="flex items-center gap-2 min-w-0"><img src="/images/avatars/avatar-3.webp" className="size-9 rounded-full border border-border-color shrink-0" alt="user"  loading="lazy"/><div className="min-w-0"><p className="text-xs font-semibold text-title truncate mb-0">Robert Cosper</p><p className="text-[11px] text-default mb-0"><a href="#">#CUS0020</a></p></div></div><div className="text-end"><p className="text-xs font-semibold text-title mb-0">$4,500</p><p className="text-[11px] text-default mb-0">Spent</p></div></div>
								<div className="flex items-center justify-between gap-3"><div className="flex items-center gap-2 min-w-0"><img src="/images/avatars/avatar-4.webp" className="size-9 rounded-full border border-border-color shrink-0" alt="user"  loading="lazy"/><div className="min-w-0"><p className="text-xs font-semibold text-title truncate mb-0">Helen Nelson</p><p className="text-[11px] text-default mb-0"><a href="#">#CUS0019</a></p></div></div><div className="text-end"><p className="text-xs font-semibold text-title mb-0">$5,200</p><p className="text-[11px] text-default mb-0">Spent</p></div></div>
								<div className="flex items-center justify-between gap-3"><div className="flex items-center gap-2 min-w-0"><img src="/images/avatars/avatar-5.webp" className="size-9 rounded-full border border-border-color shrink-0" alt="user"  loading="lazy"/><div className="min-w-0"><p className="text-xs font-semibold text-title truncate mb-0">Thomas Neal</p><p className="text-[11px] text-default mb-0"><a href="#">#CUS0018</a></p></div></div><div className="text-end"><p className="text-xs font-semibold text-title mb-0">$2,800</p><p className="text-[11px] text-default mb-0">Spent</p></div></div>
								<div className="flex items-center justify-between gap-3"><div className="flex items-center gap-2 min-w-0"><img src="/images/avatars/avatar-6.webp" className="size-9 rounded-full border border-border-color shrink-0" alt="user"  loading="lazy"/><div className="min-w-0"><p className="text-xs font-semibold text-title truncate mb-0">Sarah Spivey</p><p className="text-[11px] text-default mb-0"><a href="#">#CUS0017</a></p></div></div><div className="text-end"><p className="text-xs font-semibold text-title mb-0">$1,750</p><p className="text-[11px] text-default mb-0">Spent</p></div></div>
								<div className="flex items-center justify-between gap-3"><div className="flex items-center gap-2 min-w-0"><img src="/images/avatars/avatar-7.webp" className="size-9 rounded-full border border-border-color shrink-0" alt="user"  loading="lazy"/><div className="min-w-0"><p className="text-xs font-semibold text-title truncate mb-0">Jared Griffin</p><p className="text-[11px] text-default mb-0"><a href="#">#CUS0016</a></p></div></div><div className="text-end"><p className="text-xs font-semibold text-title mb-0">$3,000</p><p className="text-[11px] text-default mb-0">Spent</p></div></div>
							</div>
						</div>
					...
					<div className="bg-white border border-border-color rounded-md p-4">
						...
						<div className="overflow-x-auto">
							<table className="w-full text-sm">
								...
								<tbody>
									<tr className="border-b border-border-color last:border-0"><td className="py-2.5 px-2 text-xs text-default"><a href="#">#INV0020</a></td><td className="py-2.5 px-2 text-xs text-default">Invoice</td><td className="py-2.5 px-2"><div className="flex items-center gap-2"><img src="/images/avatars/avatar-3.webp" className="size-7 rounded-full border border-border-color shrink-0" alt="user"  loading="lazy"/><span className="text-xs font-semibold text-title">Alexander Kenn</span></div></td><td className="py-2.5 px-2 text-xs text-gray-900">$500</td><td className="py-2.5 px-2 text-xs text-default">11 Sep 2025</td><td className="py-2.5 px-2"><span className="text-[11px] bg-success-transparent text-success px-2 py-0.5 rounded">Paid</span></td></tr>
									<tr className="border-b border-border-color last:border-0"><td className="py-2.5 px-2 text-xs text-default"><a href="#">#SAO0019</a></td><td className="py-2.5 px-2 text-xs text-default">Sales Order</td><td className="py-2.5 px-2"><div className="flex items-center gap-2"><img src="/images/avatars/avatar-4.webp" className="size-7 rounded-full border border-border-color shrink-0" alt="user"  loading="lazy"/><span className="text-xs font-semibold text-title">Gabriella White</span></div></td><td className="py-2.5 px-2 text-xs text-gray-900">$650</td><td className="py-2.5 px-2 text-xs text-default">05 Sep 2025</td><td className="py-2.5 px-2"><span className="text-[11px] bg-warning-transparent text-warning px-2 py-0.5 rounded">Pending</span></td></tr>
									<tr className="border-b border-border-color last:border-0"><td className="py-2.5 px-2 text-xs text-default"><a href="#">#CRN0018</a></td><td className="py-2.5 px-2 text-xs text-default">Credit Note</td><td className="py-2.5 px-2"><div className="flex items-center gap-2"><img src="/images/avatars/avatar-5.webp" className="size-7 rounded-full border border-border-color shrink-0" alt="user"  loading="lazy"/><span className="text-xs font-semibold text-title">Christopher Rey</span></div></td><td className="py-2.5 px-2 text-xs text-gray-900">$120</td><td className="py-2.5 px-2 text-xs text-default">27 Aug 2025</td><td className="py-2.5 px-2"><span className="text-[11px] bg-danger-transparent text-danger px-2 py-0.5 rounded">Issued</span></td></tr>
									<tr className="border-b border-border-color last:border-0"><td className="py-2.5 px-2 text-xs text-default"><a href="#">#SAQ0017</a></td><td className="py-2.5 px-2 text-xs text-default">Sales Quote</td><td className="py-2.5 px-2"><div className="flex items-center gap-2"><img src="/images/avatars/avatar-6.webp" className="size-7 rounded-full border border-border-color shrink-0" alt="user"  loading="lazy"/><span className="text-xs font-semibold text-title">Penelope Ton</span></div></td><td className="py-2.5 px-2 text-xs text-gray-900">$860</td><td className="py-2.5 px-2 text-xs text-default">16 Aug 2025</td><td className="py-2.5 px-2"><span className="text-[11px] bg-info-transparent text-info px-2 py-0.5 rounded">Sent</span></td></tr>
									<tr className="border-b border-border-color last:border-0"><td className="py-2.5 px-2 text-xs text-default"><a href="#">#INV0011</a></td><td className="py-2.5 px-2 text-xs text-default">Invoice</td><td className="py-2.5 px-2"><div className="flex items-center gap-2"><img src="/images/avatars/avatar-7.webp" className="size-7 rounded-full border border-border-color shrink-0" alt="user"  loading="lazy"/><span className="text-xs font-semibold text-title">Catherine Lan</span></div></td><td className="py-2.5 px-2 text-xs text-gray-900">$650</td><td className="py-2.5 px-2 text-xs text-default">18 May 2025</td><td className="py-2.5 px-2"><span className="text-[11px] bg-success-transparent text-success px-2 py-0.5 rounded">Paid</span></td></tr>
								</tbody>
							</table>
						</div>
					</div>
