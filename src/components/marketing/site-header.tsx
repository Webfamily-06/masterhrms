...
const erpModules: MenuItem[] = [
  {
    ...
    desc: "Ledgers, invoices, tax, multi-currency",
    icon: Landmark,
    to: "/product#financials",
  },
  {
    title: "Sales & CRM Pipeline",
    desc: "Leads, deals, quotes, forecast",
    icon: TrendingUp,
    to: "/product#crm",
  },
  {
    title: "Supply Chain & Stock",
    desc: "Multi-warehouse, SKUs, reorders",
    icon: Boxes,
    to: "/product#inventory",
  },
  {
    title: "Procurement & POs",
    desc: "Purchase requests, vendor portal",
    icon: ShoppingCart,
    to: "/product#procurement",
  },
  {
    title: "BI Enterprise Analytics",
  ...
  },
  {
    ...
    desc: "Employee directory, automated pay runs",
    icon: Users,
    to: "/product#core-hr",
  },
  {
    title: "Geo-Attendance & Time",
    desc: "Biometric sync, GPS clock-in",
    icon: Clock,
    to: "/product#attendance",
  },
  {
    title: "OKRs & Performance",
    desc: "360° appraisals, goal cascades",
    icon: Target,
...
const industries: MenuItem[] = [
  {
    title: "Tech & Startups",
    desc: "Fast scaling, global teams",
    icon: Building2,
    to: "/solutions#tech",
  },
  {
    title: "Manufacturing",
    desc: "Shifts, overtime, compliance",
    icon: Factory,
    to: "/solutions#manufacturing",
  },
  {
    title: "Healthcare",
    desc: "Rosters, credential tracking",
    icon: HeartPulse,
    to: "/solutions#healthcare",
  },
  {
    title: "Retail & Services",
    desc: "Multi-location attendance",
    icon: ShoppingBag,
    to: "/solutions#retail",
  },
  {
    title: "Financial Services",
    desc: "Audit trails, strict permissions",
    icon: Landmark,
    to: "/solutions#finance",
  },
  {
    title: "Education",
    desc: "Faculty & staff workflows",
    icon: School,
...
const resources: MenuItem[] = [
  {
    title: "Blog & Insights",
    desc: "HR trends, best practices",
    icon: BookOpen,
    to: "/resources#blog",
  },
  {
    title: "Guides & Ebooks",
    desc: "Compliance & payroll playbooks",
    icon: FileText,
    to: "/resources#guides",
  },
  {
    title: "Customer Stories",
    desc: "How teams scale with us",
    icon: Newspaper,
    to: "/resources#stories",
  },
  {
    title: "Help Center",
    desc: "Docs, API, support ticket desk",
    icon: HelpCircle,
    to: "/resources#help",
  },
];
...
export function SiteHeader() {
  ...
  try {
    if (typeof window !== "undefined") {
      cachedLogo = isDark
        ? localStorage.getItem("master_hrms_logo_dark") ||
          localStorage.getItem("master_hrms_logo_light") ||
          ""
        : localStorage.getItem("master_hrms_logo_light") ||
          localStorage.getItem("master_hrms_logo_dark") ||
          "";
    ...
    <header className="sticky top-0 z-40 border-b bg-background/95 backdrop-blur-xs">
      ...
      <div className="max-w-7xl mx-auto flex h-16 items-center justify-between px-4 sm:px-6">
        ...
        <nav className="hidden lg:flex items-center gap-1 text-sm">
          ...
          <Link
            to="/addons"
            className="px-3 py-2 rounded-md hover:bg-accent text-muted-foreground hover:text-foreground inline-flex items-center gap-1.5"
          >
            <Puzzle className="size-3.5" /> Addons
          </Link>
          <Link
            to="/pricing"
            className="px-3 py-2 rounded-md hover:bg-accent text-muted-foreground hover:text-foreground"
          >
            Pricing
          </Link>
      ...
      {mobileOpen && (
        <div className="lg:hidden border-t p-4 space-y-3 bg-background">
          <Link to="/product" className="block py-2 text-sm font-medium">
            Product
          </Link>
          <Link to="/solutions" className="block py-2 text-sm font-medium">
            Solutions
          </Link>
          <Link to="/addons" className="block py-2 text-sm font-medium">
            Addons
          </Link>
          <Link to="/pricing" className="block py-2 text-sm font-medium">
            Pricing
          </Link>
          <Link to="/resources" className="block py-2 text-sm font-medium">
            Resources
          </Link>
