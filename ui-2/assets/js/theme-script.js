...
document.querySelector("html").setAttribute('data-topbarcolor', (localStorage.getItem('topbarcolor') && localStorage.getItem('topbarcolor') !== 'null') ? localStorage.getItem('topbarcolor') : 'white');
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function handleInputChange() {
        ...
        if (document.querySelector('input[name="topbarcolor"]:checked') != null) {
            ...
            topbarcolor = localStorage.getItem('topbarcolor');
            if (!topbarcolor || topbarcolor === 'all' || topbarcolor === 'null') {
                topbarcolor = 'white';
            }
        }
    ...
    if (savedTopbarcolor === 'null' || savedTopbarcolor === 'all') savedTopbarcolor = 'white';
